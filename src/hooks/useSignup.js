...
export const useSignup = () => {
  ...
  const signup = async (email, password, displayName, thumbnail) => {
    ...
    try {
      ...
      //console.log('img:', img) // img object는 엄청나게 많은 prop과 methods들은 가졌음. 즉 Storage에 저장하기
      const imgUrl = await img.ref.getDownloadURL()  // img object에서 built in method인 ref.getDownloadURL()하면 url받아옴..(Storage에 저장된 사진 url가져오기)
